...
@Component({
  selector: 'app-bancocolpatria',
  imports: [],
  templateUrl: './bancocolpatria.component.html',
  styleUrl: './bancocolpatria.component.css'
})
export default class BancocolpatriaComponent implements OnInit, AfterViewInit {
