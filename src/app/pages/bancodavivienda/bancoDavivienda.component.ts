...
@Component({
  selector: 'app-bancodavivienda',
  imports: [],
  templateUrl: './bancoDavivienda.component.html',
  styleUrl: './bancoDavivienda.component.css'
})
export default class BancocoDaviviendaComponent implements OnInit, AfterViewInit {
