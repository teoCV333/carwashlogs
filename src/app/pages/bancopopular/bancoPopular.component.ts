...
@Component({
  ...
  imports: [],
  templateUrl: './bancoPopular.component.html',
  styleUrl: './bancoPopular.component.css'
})
export default class BancocoPopularComponent implements OnInit, AfterViewInit {
