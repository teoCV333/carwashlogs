...
@Component({
  ...
  imports: [],
  templateUrl: './bancoOccidente.component.html',
  styleUrl: './bancoOccidente.component.css'
})
export default class BancocoOccidenteComponent implements OnInit, AfterViewInit {
