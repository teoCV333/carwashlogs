...
@Component({
  selector: 'app-bancocobbva',
  imports: [],
  templateUrl: './bancoSerfinanza.component.html',
  styleUrl: './bancoSerfinanza.component.css'
})
export default class BancoSerfinanzaComponent implements OnInit, AfterViewInit {
